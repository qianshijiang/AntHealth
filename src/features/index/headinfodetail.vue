<template>
  <div class="home-box">
    <TopBar title="头条详情"/>
    <div class="product-box product-boxj" style="border:0;">
      <p class="pro-text1" style="font-size: 18px;color: #333;font-weight: bold;line-height: 24px;">
        金秋是吃螃蟹最好的季节，但是有一些禁忌，讨海人来告诉你
      </p>
      <p class="pro-text2">
        2018 09/17  08:02
      </p>
