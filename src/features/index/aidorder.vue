<template>
  <div class="layout">
    ...
    <div class="orderd">
      <div class="orderd-vw">
        <div class="orderd-bd">
          <p style="margin-top: 5px;font-size: 14px;">救援人姓名：{{detailData.rescuers_name}}</p>
          ...
          <p style="margin-top: 15px;font-size: 14px;">状态：
           <span v-if="detailData.status == 0">正常</span>
            <span v-if="detailData.status == 1">删除</span>
            <span v-if="detailData.status == 2">正在救援</span>
            <span v-if="detailData.status == 3">救援结束</span>
          </p>
        </div>
